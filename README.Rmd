...
This `csv` file should contain one column, the name of this column will be the name of the product to be evaluated, for example `"Copa"`. The values of this first columns, will be the product to be evaluated.
